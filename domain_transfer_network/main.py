...
def build_parser():
    ...
    parser.add_argument('--max-iter', type=int,
                    help='Train iterations', default=10000)

    parser.add_argument('--batchs', type=int,
                    help='Batch size', default=8)

    parser.add_argument('--lr', type=float,
                    help='Learning rate to optimize network', default=0.07)

    parser.add_argument('--check-iter', type=int,
                    help='Number of iteration to check training logs', default=500)
    ...
    parser.add_argument('--content-layers', type=int, nargs='+', 
                    help='layer indices to extract content features', default=[8])
    
    parser.add_argument('--style-layers', type=int, nargs='+',
                    help='layer indices to extract style features', default=[ 3,8, 15])

    parser.add_argument('--content-weight', type=float, 
                    help='content loss weight', default=30.0)
    
    parser.add_argument('--style-weight', type=float,
                    help='style loss weight', default=30.0)

    parser.add_argument('--tv-weight', type=float,
                    help='tv loss weight', default=4.0)
