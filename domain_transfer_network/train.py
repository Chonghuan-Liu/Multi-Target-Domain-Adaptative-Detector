...
from domain_transfer_network.image_utils import ImageFolder, get_transformer, imload, imsave
...
def network_train(args):
    ...
    for iteration in tqdm(range(args.max_iter)):
        ...
        # print loss logs,check_iter默认是100
        if iteration % args.check_iter == 0:
            ...
            torch.save(transform_network.state_dict(), args.save_path+"transform_network"+str(iteration)+'.pth')
