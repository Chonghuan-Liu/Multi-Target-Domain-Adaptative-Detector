...
class ImageFolder(torch.utils.data.Dataset):
    def __init__(self, root_path, transform):
        ...
        self.file=open('./train_data_txt/trainval_transfer_net.txt','r')
        self.file_names=self.file.readlines()
    ...
    def __getitem__(self, index):
        image = Image.open(os.path.join(self.root_path + self.file_names[index][:-1]+'.jpg')).convert("RGB")
